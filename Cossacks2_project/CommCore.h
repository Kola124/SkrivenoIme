...
#define RETRY_COUNT				16			// Сколько раз нужно пытаться отослать пакет
...
#define RETRY_TIME				200			// Интервал повтора отправки пакет в миллисекундах

#define MAX_QUEUE_LEN			8192		// Максимальная длина очереди пакетов
